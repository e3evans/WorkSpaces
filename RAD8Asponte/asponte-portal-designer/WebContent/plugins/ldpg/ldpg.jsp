...
<div id="<%=ns%>ldpgBuilder">
	<div>
		<label for="<%=ns%>ldpgPageTitle" title="<fmt:message key="ldpg_builder_title_label_tip" />"><fmt:message key="ldpg_builder_title_label" /></label><br />
		<input type="text" name="landing_page_title" id="<%=ns%>ldpgPageTitle" value="" dojoType="dijit.form.ValidationTextBox" trim="true" propercase="true" required="true" invalidMessage="<fmt:message key="ldpg_builder_invalid_title_message" />" regExp="[^\s].*" />
	</div>
</div><%
