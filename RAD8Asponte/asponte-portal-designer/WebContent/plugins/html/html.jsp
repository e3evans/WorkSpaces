...
final String METHOD_NAME="html.jsp";
if(Jsp.LOGGER.isLoggable(java.util.logging.Level.FINER)){Jsp.LOGGER.finest(METHOD_NAME+": ENTRY ("+ns+")");}
%><script type="text/javascript" language="JavaScript">
dojo.require('dijit.form.ValidationTextBox');
</script>
<div id="<%=ns%>htmlBuilder">
	<div>
		<label for="<%=ns%>htmlPageTitle" title="<fmt:message key="html_builder_title_label_tip" />"><fmt:message key="html_builder_title_label" /></label><br />
		<input type="text" name="html_title" id="<%=ns%>htmlPageTitle" value="" dojoType="dijit.form.ValidationTextBox" trim="true" propercase="true" required="true" invalidMessage="<fmt:message key="html_builder_invalid_title_message" />" regExp="[^\s].*" />
	</div>
</div><%
