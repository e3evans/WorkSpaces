<%@ page session="true" contentType="text/html" import="java.util.*,java.util.logging.*,com.ibm.workplace.wcm.api.*,com.asponte.wcm.widgets.*,com.asponte.commons.portal.wcm.*"
    ...
    final String METHOD_NAME="addDocLinkTool.jsp";
        ...
        try{
            ...
            if(docid!=null){
            	...
            	if(awwDesignLib!=null){
                    ...
                    if(isDebugEnabled){Jsp.LOGGER.finest(METHOD_NAME+": Locating the component named '"+Constants.ADD_DOCUMENT_LINK_TOOL+"'...");}
                    DocumentIdIterator itr=wkspc.findComponentByName(Constants.ADD_DOCUMENT_LINK_TOOL);
                    if(itr.hasNext()){
