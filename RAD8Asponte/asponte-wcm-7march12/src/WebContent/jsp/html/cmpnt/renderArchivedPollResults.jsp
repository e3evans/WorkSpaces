...
<div class="awwPollRefresh"><a href="<portlet:actionURL/>">Return to Archived Polls List</a></div><%
				}else{
					// TODO: $$NON-NLS$$
				%><span>Poll results are not currently available.</span><div class="awwPollRefresh"><a href="<portlet:actionURL/>">Return to Archived Polls List</a></div>
				<%
				}	
			}
		}catch(Throwable t){
