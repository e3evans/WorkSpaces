...
<% 
  ...
  if( preferences!=null ) {
    String value = (String)preferences.getValue(com.ibm.slwcmbulkupload.SLWcmBulkUploadPortlet.EDIT_KEY,"");
%> 
  <FORM ACTION="<portlet:actionURL/>" METHOD="POST">
    <LABEL for="<%=com.ibm.slwcmbulkupload.SLWcmBulkUploadPortlet.EDIT_TEXT%>">New Value</LABEL><BR>
    <INPUT name="<%=com.ibm.slwcmbulkupload.SLWcmBulkUploadPortlet.EDIT_TEXT%>" value="<%=value%>" type="text"/><BR>
    <INPUT name="<%=com.ibm.slwcmbulkupload.SLWcmBulkUploadPortlet.EDIT_SUBMIT%>" value="Save" type="submit"/>
  </FORM>
<%
  }
else {
