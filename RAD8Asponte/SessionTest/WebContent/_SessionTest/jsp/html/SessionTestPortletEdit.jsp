...
<% 
  ...
  if( preferences!=null ) {
    String value = (String)preferences.getValue(com.ibm.sessiontest.SessionTestPortlet.EDIT_KEY,"");
%> 
  <FORM ACTION="<portlet:actionURL/>" METHOD="POST">
    <LABEL for="<%=com.ibm.sessiontest.SessionTestPortlet.EDIT_TEXT%>">New Value</LABEL><BR>
    <INPUT name="<%=com.ibm.sessiontest.SessionTestPortlet.EDIT_TEXT%>" value="<%=value%>" type="text"/><BR>
    <INPUT name="<%=com.ibm.sessiontest.SessionTestPortlet.EDIT_SUBMIT%>" value="Save" type="submit"/>
  </FORM>
<%
  }
else {
