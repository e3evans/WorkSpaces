<%-- jsf:pagecode language="java" location="/JavaSource/pagecode/GEMTEntryForm/GEMTEntryFormParentReport.java" --%><%-- /jsf:pagecode --%>
...
<f:view>
	...
	<hx:scriptCollector id="scriptCollector1" preRender="#{pc_GEMTEntryFormParentReport.onPageLoadBegin}"><h:form styleClass="form" id="form1" style="font-size:9.5pt;font-family:Arial;">
			...
			<TABLE class="GEMTTable" border="0" cellpadding="0" cellspacing="0" width="100%">
				<TBODY>
					...
					<TR>
						...
						<hx:commandExButton type="submit" value=" < Return to Final Report"
							styleClass="GEMTCommandButtonOrange" id="cancel" action="#{pc_GEMTEntryFormParentReport.doCancelAction}" 
			...
			<div class="GEMTOrangeTableContainer">
				<TABLE class="GEMTTable" border="0" cellpadding="0" cellspacing="0">
					<TBODY>
						...
						<TR>
							<TD class="GEMTOrangeSectionResults" valign="top">
							...
							<TD class="GEMTOrangeSectionResults" valign="top" style="padding-right:5px;">
			...
			<br>
			<br>
				<h:panelGroup styleClass="GEMTOrangeTableContainer">
				<h:dataTable value="#{pc_GEMTEntryFormReportEdit.files}"
								var="file"
								cellpadding="0"
								cellspacing="0"
				...
				<TBODY>
					<TR>
						...
						<hx:commandExButton type="submit" value=" < Return to Final Report"
							...
							id="cancel2" action="#{pc_GEMTEntryFormParentReport.doCancelAction}" ></hx:commandExButton>
						</TD>
					</TR>
					<TR>
						<TD style="background-color:#d47d18;">
