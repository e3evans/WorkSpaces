...
import com.manpower.portal.mpnet.hbn.beans.VCandidateResume;

/**
 * @author jsingh
 *  
 */
public class VCandidateResumeDAOHibernate extends GenericHibernateDAO implements
		VCandidateResumeDAO {
	 ...
	 * @param session
	 */
	public VCandidateResumeDAOHibernate(Session session) {
		super(VCandidateResume.class, session);
	}
