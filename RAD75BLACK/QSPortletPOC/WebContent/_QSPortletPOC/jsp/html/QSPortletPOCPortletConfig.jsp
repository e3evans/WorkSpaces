...
<% 
  ...
  if( preferences!=null ) {
    String value = (String)preferences.getValue(com.ibm.qsportletpoc.QSPortletPOCPortlet.CONFIG_KEY,"");
%> 
  <FORM ACTION="<portlet:actionURL/>" METHOD="POST">
    <LABEL for="<%=com.ibm.qsportletpoc.QSPortletPOCPortlet.CONFIG_TEXT%>">New Value</LABEL><BR>
    <INPUT name="<%=com.ibm.qsportletpoc.QSPortletPOCPortlet.CONFIG_TEXT%>" value="<%=value%>" type="text"/><BR>
    <INPUT name="<%=com.ibm.qsportletpoc.QSPortletPOCPortlet.CONFIG_SUBMIT%>" value="Save" type="submit"/>
  </FORM>
<%
  }
else {
