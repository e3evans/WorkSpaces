...
<% 
  ...
  if( preferences!=null ) {
    String value = (String)preferences.getValue(com.manpower.tridiontest.TridionTestPortlet.EDIT_KEY,"");
%> 
  <FORM ACTION="<portlet:actionURL/>" METHOD="POST">
    <LABEL for="<%=com.manpower.tridiontest.TridionTestPortlet.EDIT_TEXT%>">New Value</LABEL><BR>
    <INPUT name="<%=com.manpower.tridiontest.TridionTestPortlet.EDIT_TEXT%>" value="<%=value%>" type="text"/><BR>
    <INPUT name="<%=com.manpower.tridiontest.TridionTestPortlet.EDIT_SUBMIT%>" value="Save" type="submit"/>
  </FORM>
<%
  }
else {
