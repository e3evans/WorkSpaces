//$Id: WebSphereExtendedJTATransactionLookup.java,v 1.1 2007/11/09 03:10:25 jsingh Exp $
	...
	public static class TransactionManagerAdapter implements TransactionManager {
		...
		public class TransactionAdapter implements Transaction {
			...
			private Object getLocalId() throws HibernateException {
				try {
				    if (localId == null) {
					    localId = getLocalIdMethod.invoke( extendedJTATransaction, null );
				    }
				    return localId;
				}
				catch ( Exception e ) {
