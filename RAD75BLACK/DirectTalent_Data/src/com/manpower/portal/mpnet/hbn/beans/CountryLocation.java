...
public class CountryLocation implements Serializable{
	...
	private static final long serialVersionUID =     5193690890817381307L;
	...
	private String 	language				= null,
					...
					updatedBy				= null,
					createdBy				= null,
					preferredLocationFlag 	= null;
	
	private Date	updatedOn				= null,
					createdOn				= null;

	private Map		locationNames			= null;
	 ...
	 */
	public Map getLocationNames() {
		return locationNames;
	}
	/**
	 * @param locationNames The locationNames to set.
	 */
	public void setLocationNames(Map locationNames) {
		this.locationNames = locationNames;
	}
	/**
	 * @return Returns the preferredLocationFlag.
	 */
	public String getPreferredLocationFlag() {
		return preferredLocationFlag;
	}
	/**
	 * @param preferredLocationFlag The preferredLocationFlag to set.
	 */
	public void setPreferredLocationFlag(String preferredLocationFlag) {
		this.preferredLocationFlag = preferredLocationFlag;
	}
}
