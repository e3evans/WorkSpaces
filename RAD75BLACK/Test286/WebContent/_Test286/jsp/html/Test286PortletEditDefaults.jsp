<%@page session="false" contentType="text/html" pageEncoding="ISO-8859-1" import="javax.portlet.*,com.ibm.test286.*" %>
...
<% 
  ...
  if (preferences != null) {
    String value = (String)preferences.getValue(com.ibm.test286.Test286Portlet.EDIT_DEFAULTS_KEY, "");
%> 
  <FORM ACTION="<portlet:actionURL/>" METHOD="POST">
    <LABEL for="<%=com.ibm.test286.Test286Portlet.EDIT_DEFAULTS_TEXT%>">New Value</LABEL><BR>
    <INPUT name="<%=com.ibm.test286.Test286Portlet.EDIT_DEFAULTS_TEXT%>" value="<%=value%>" type="text"/><BR>
    <INPUT name="<%=com.ibm.test286.Test286Portlet.EDIT_DEFAULTS_SUBMIT%>" value="Save" type="submit"/>
  </FORM>
<%
  } else {
