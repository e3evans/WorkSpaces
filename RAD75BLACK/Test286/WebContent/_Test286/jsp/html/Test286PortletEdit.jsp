...
<% 
  ...
  if( preferences!=null ) {
    String value = (String)preferences.getValue(com.ibm.test286.Test286Portlet.EDIT_KEY,"");
%> 
  <FORM ACTION="<portlet:actionURL/>" METHOD="POST">
    <LABEL for="<%=com.ibm.test286.Test286Portlet.EDIT_TEXT%>">New Value</LABEL><BR>
    <INPUT name="<%=com.ibm.test286.Test286Portlet.EDIT_TEXT%>" value="<%=value%>" type="text"/><BR>
    <INPUT name="<%=com.ibm.test286.Test286Portlet.EDIT_SUBMIT%>" value="Save" type="submit"/>
  </FORM>
<%
  }
else {
