...
<% 
  ...
  if( preferences!=null ) {
    String value = (String)preferences.getValue(com.ibm.vlado2.Vlado2Portlet.EDIT_KEY,"");
%> 
  <FORM ACTION="<portlet:actionURL/>" METHOD="POST">
    <LABEL for="<%=com.ibm.vlado2.Vlado2Portlet.EDIT_TEXT%>">New Value</LABEL><BR>
    <INPUT name="<%=com.ibm.vlado2.Vlado2Portlet.EDIT_TEXT%>" value="<%=value%>" type="text"/><BR>
    <INPUT name="<%=com.ibm.vlado2.Vlado2Portlet.EDIT_SUBMIT%>" value="Save" type="submit"/>
  </FORM>
<%
  }
else {
