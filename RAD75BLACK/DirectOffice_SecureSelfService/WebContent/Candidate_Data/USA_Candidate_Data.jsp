...
<f:subview id="usaCandidateData_subview">
	...
	<h:panelGrid id="us_data_pg" 
		...
		<h:column id="us_data_col1">
			...
			<h:panelGrid id="mail_panelGrid" width="100%">
					...
					<h:panelGrid id="personalInfo" columns="2" 
						...
						<f:facet name="header">
							<h:column>
								...
								<f:verbatim>
									<a id="cannot_change_href" href="javascript:setUSAVisible('myManpowerCSS_cannotChangePopupHelp')">
								</f:verbatim>
								
								<h:outputText id="cange_out_txt" 
											styleClass="myManpowerCSS_optionsTitle"
											value="#{nlfile.why_cannot_change}">
								</h:outputText>
						...
						<h:column id="personalInfo_col2">
							<h:inputText id="title_in" value="#{pc_USA_Candidate_Data.generalInformation.title}" readonly="true" styleClass="manpower_read_only_box"></h:inputText>
						</h:column>
						...
						<h:column id="personalInfo_col4">
							<h:inputText id="first_name_in" value="#{pc_USA_Candidate_Data.candidateProfile.firstName}" readonly="true" styleClass="manpower_read_only_box"></h:inputText>
						</h:column>
						<h:column id="personalInfo_col5">
							<h:outputText id="know_as_out" value="#{nlfile.known_as}"></h:outputText>
						</h:column>
						<h:column id="personalInfo_col6">
							<h:inputText id="know_as_in" value="#{pc_USA_Candidate_Data.generalInformation.knownAs}" readonly="true" styleClass="manpower_read_only_box"></h:inputText>
						</h:column>
						...
						<h:column id="personalInfo_col8">
							<h:inputText id="middle_name_in" value="#{pc_USA_Candidate_Data.candidateProfile.middleName}" readonly="true" styleClass="manpower_read_only_box"></h:inputText>
						</h:column>
						<h:column id="personalInfo_col9">
							<h:outputText id="last_name_out" value="#{nlfile.surname}"></h:outputText>
						</h:column>
						<h:column id="personalInfo_col10">
							<h:inputText id="last_name_in" value="#{pc_USA_Candidate_Data.generalInformation.lastName}" readonly="true" styleClass="manpower_read_only_box"></h:inputText>
						</h:column>
				...
				<h:column>
					<h:panelGrid id="main_addr_pg" columnClasses="myManpowerCSS_column-left-aligned" 
				...
				<h:column id="mail_col2">
					<h:panelGrid id="mainAddress_panelGrid" 
								columns="2" 
								columnClasses="myManpowerCSS_column-right-aligned, myManpowerCSS_column-right-aligned" >
						...
						<h:column id="mainAddress_col2">
							<h:inputText id="mail_addr_in" value="#{pc_USA_Candidate_Data.candidateProfile.payrollAddress.addressLine1}" readonly="true" styleClass="manpower_read_only_box"></h:inputText>
						</h:column>
						...
						<h:column id="mainAddress_col4">
							<h:inputText id="mail_addr2_in" value="#{pc_USA_Candidate_Data.candidateProfile.payrollAddress.addressLine2}" readonly="true" styleClass="manpower_read_only_box"></h:inputText>
						</h:column>
						...
						<h:column id="mainAddress_col6">
							<h:inputText id="mail_city_in" value="#{pc_USA_Candidate_Data.candidateProfile.payrollAddress.city}" readonly="true" styleClass="manpower_read_only_box"></h:inputText>
						</h:column>
						...
						<h:column id="mainAddress_col8">
							<h:inputText id="mail_reg_in" value="#{pc_USA_Candidate_Data.candidateProfile.payrollAddress.state_province}" readonly="true" styleClass="manpower_read_only_box"></h:inputText>
						</h:column>
						...
						<h:column id="mainAddress_col10">
							<h:inputText id="mail_post_in" value="#{pc_USA_Candidate_Data.candidateProfile.payrollAddress.postal_code}" readonly="true" styleClass="manpower_read_only_box"></h:inputText>
						</h:column>
						...
						<h:column id="mainAddress_col12">
							<h:inputText id="mail_country_in" value="#{pc_USA_Candidate_Data.candidateProfile.payrollAddress.country}" readonly="true" styleClass="manpower_read_only_box"></h:inputText>
						</h:column>
					</h:panelGrid>
				</h:column>
		...
		<h:column id="us_data_col2">
			<f:verbatim>
				<div id="right_padding_1" style="padding-right: 20px; padding-top: 10px;">
			</f:verbatim>
					...
					<h:panelGrid id="rightToWork_inner_panelGrid" 
						...
						<h:column id="rightToWork_inner_col2">
							<h:selectOneMenu id="legalAgeMenu"
										value="#{pc_USA_Candidate_Data.eighteenYearsOldorOlder}">
								
								<f:selectItems value="#{pc_USA_Candidate_Data.workSelectItems}"/>
							</h:selectOneMenu>
						</h:column>
						<h:column id="rightToWork_inner_col3">
							<h:outputText id="citizen_out" value="#{nlfile.us_citizen}"></h:outputText>
						</h:column>
						<h:column id="rightToWork_inner_col4">
							<h:selectOneMenu id="citizenMenu"
										value="#{pc_USA_Candidate_Data.usaCitizen}">
								<f:selectItems value="#{pc_USA_Candidate_Data.workSelectItems}"/>
							</h:selectOneMenu>
						</h:column>
						<h:column id="rightToWork_inner_col5">
							<h:outputText id="work_out" value="#{nlfile.entitled_work_us}"></h:outputText>
						</h:column>
						<h:column id="rightToWork_inner_col6">
							<h:selectOneMenu id="entitledMenu"
										value="#{pc_USA_Candidate_Data.legallyEntiltedToWork}">
								<f:selectItems value="#{pc_USA_Candidate_Data.workSelectItems}"/>
							</h:selectOneMenu>
						</h:column>
						<h:column id="rightToWork_inner_col7">
							<h:outputText id="ssn_out" value="#{nlfile.have_ssn_number}"></h:outputText>
						</h:column>
						<h:column id="rightToWork_inner_col8">
							<h:selectOneMenu id="ssnMenu"
											value="#{pc_USA_Candidate_Data.haveGovernmentId}">
								<f:selectItems value="#{pc_USA_Candidate_Data.workSelectItems}"/>
							</h:selectOneMenu>
						</h:column>
						...
						<h:column id="rightToWork_inner_col10">
							<h:selectOneMenu id="visaMenu"
											value="#{pc_USA_Candidate_Data.haveWorkVisa}">
								<f:selectItems value="#{pc_USA_Candidate_Data.workVisaSelectItems}"/>
							</h:selectOneMenu>
						...
						<h:column id="rightToWork_inner_col12">
							...
							<f:verbatim>
								<div style="block; padding-top: 10px" id="block_div1">
							</f:verbatim>
							<h:inputText id="datum1"
										style="width: 112px"  
										value="#{pc_USA_Candidate_Data.workVisaExpirationDate}">
							</h:inputText>
							
							<f:verbatim>
									<a href="#" onClick="setYears(1800, 2020);
								       showCalender(this, 'datum1', 'usa');">
						...
						<h:column id="rightToWork_inner_col13">
							...
							<h:outputText id="convictions_out" value="#{nlfile.have_criminal_convictions}"></h:outputText>
						</h:column>
						<h:column id="rightToWork_inner_col14">
							<h:inputText id="convictionsMenu" 
										style="width: 112px" 
										value="#{pc_USA_Candidate_Data.criminalConviction}">
							</h:inputText>
							
						</h:column>
						<h:column id="rightToWork_inner_col15">
							<h:outputText id="drug_out" value="#{nlfile.take_drug_test}"></h:outputText>
						</h:column>
						<h:column id="rightToWork_inner_col16">
							<h:selectOneMenu id="drugsMenu"
											value="#{pc_USA_Candidate_Data.willingToTakeDrugTest}">
								<f:selectItems value="#{pc_USA_Candidate_Data.workSelectItems}"/>
							</h:selectOneMenu>
						</h:column>
					</h:panelGrid>
					...
					<f:verbatim>
						...
						<h:panelGrid id="tax_payroll_panelGrid" 
							...
							<h:column id="tax_payroll_col2">
								<h:inputText id="bo_in" value="#{pc_USA_Candidate_Data.candidateProfile.backOfficeIDNumber}" readonly="true"  styleClass="manpower_read_only_box"></h:inputText>
							</h:column>
							...
							<h:column id="tax_payroll_col4">
								...
								<h:inputText id="datum2" 
											value="#{pc_USA_Candidate_Data.dateOfBirth}" 
											style="width: 112px">
								</h:inputText>
							...
							<h:column id="tax_payroll_col5">
								<h:outputText id="deposit_out" value="#{nlfile.accept_deposit_by_mail}"></h:outputText>
							</h:column>
							<h:column id="tax_payroll_col6">
								<h:selectOneMenu id="depositMenu"
												value="#{pc_USA_Candidate_Data.acceptDirectDepositByEmail}">
									<f:selectItems value="#{pc_USA_Candidate_Data.workSelectItems}"/>
								</h:selectOneMenu>
							</h:column>
						</h:panelGrid>
			...
			<h:panelGrid id="payment_addr_pg" style="text-align: left">
				<f:facet name="header">
					<h:column id="main_col1">
						...
						<f:verbatim>
							<a id="why_need_href" href="javascript:setUSAVisible('myManpowerCSS_mainAdddrNeedPopupHelp')">
						</f:verbatim>
			...
			<f:verbatim>
				...
				<h:panelGrid id="main_panelGrid" 
					...
					<f:facet name="header">
						<h:panelGrid columns="2"
							...
							<h:column id="main_col3">
								<h:selectOneMenu id="payrollDiffFromMain" value="#{pc_USA_Candidate_Data.candidateProfile.paymentAddrDiffFromMain}">
									<f:selectItems value="#{pc_USA_Candidate_Data.selectItems}"/>
								</h:selectOneMenu>
							</h:column>
							
							<h:column id="header_col1">
								<h:outputText id="payrollDiffError" 
											style="color: red; display: none; text-align: right" 
					...
					<h:column id="main_col5">
						<h:inputText id="addressLineOne" value="#{pc_USA_Candidate_Data.generalInformation.mainAddress.addressLine1}" style="width: 200px"></h:inputText>
					...
					<h:column id="main_col7">
						<h:inputText id="main_addr2_in" value="#{pc_USA_Candidate_Data.generalInformation.mainAddress.addressLine2}" style="width: 200px"></h:inputText>
					...
					<h:column id="main_col8">
						<h:inputText id="main_city_in" value="#{pc_USA_Candidate_Data.generalInformation.mainAddress.city}" style="width: 200px"></h:inputText>
					...
					<h:column id="main_col10">
						<h:selectOneMenu id="main_state_select"
								value="#{pc_USA_Candidate_Data.generalInformation.mainAddress.state_province}" 
								style="width: 200px">
							<f:selectItems value="#{pc_USA_Candidate_Data.regionSelectItems}"/>
						</h:selectOneMenu>
					...
					<h:column id="main_col12">
						<h:inputText id="main_code_in" value="#{pc_USA_Candidate_Data.generalInformation.mainAddress.postal_code}" style="width: 200px"></h:inputText>
					...
					<h:column id="main_col14">
						<h:inputText id="main_country_in" value="#{pc_USA_Candidate_Data.generalInformation.mainAddress.country}" style="width: 200px"></h:inputText>
			...
			<h:panelGrid id="usControl_panelGrid" columns="3">
				...
				<h:column>
					<h:commandButton id="submitChangesBtn" 
						actionListener="#{pc_USA_Candidate_Data.submitData}"
						action="#{pc_USA_Candidate_Data.submit}"
				...
				<h:column>
					<h:commandButton id="cancelChangesBtn" 
						actionListener="#{pc_USA_Candidate_Data.cancel}"
