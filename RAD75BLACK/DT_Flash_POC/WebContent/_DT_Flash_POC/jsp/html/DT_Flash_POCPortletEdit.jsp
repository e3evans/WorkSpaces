...
<% 
  ...
  if( preferences!=null ) {
    String value = (String)preferences.getValue(com.manpower.portal.portlet.dt_flash_poc.DT_Flash_POCPortlet.EDIT_KEY,"");
%> 
  <FORM ACTION="<portlet:actionURL/>" METHOD="POST">
    <LABEL for="<%=com.manpower.portal.portlet.dt_flash_poc.DT_Flash_POCPortlet.EDIT_TEXT%>">New Value</LABEL><BR>
    <INPUT name="<%=com.manpower.portal.portlet.dt_flash_poc.DT_Flash_POCPortlet.EDIT_TEXT%>" value="<%=value%>" type="text"/><BR>
    <INPUT name="<%=com.manpower.portal.portlet.dt_flash_poc.DT_Flash_POCPortlet.EDIT_SUBMIT%>" value="Save" type="submit"/>
  </FORM>
<%
  }
else {
